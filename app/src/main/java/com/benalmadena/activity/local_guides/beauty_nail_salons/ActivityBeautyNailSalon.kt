...
class ActivityBeautyNailSalon:BaseFragment() {
    ...
    fun initRecyclerView() {
        ...
        listData.add(BarNightLife("Beauty Treatments in Benalmadena", R.drawable.beauty_nail_salons_3,ActivityPropertyToBuy(),"",1))
        listData.add(BarNightLife("Art of Hair", R.drawable.img_17,ActivityPropertyToBuy(),"",1))
        listData.add(BarNightLife("The Salon", R.drawable.img_6,ActivityPropertyToBuy(),"",1))
        listData.add(BarNightLife("Divas Wedding Hair and Makeup", R.drawable.beauty_nail_salons_4,ActivityPropertyToBuy(),"",1))
        ...
        listData.add(BarNightLife("Divas Hair & Beauty", R.drawable.img_6,ActivityPropertyToBuy(),"",1))
