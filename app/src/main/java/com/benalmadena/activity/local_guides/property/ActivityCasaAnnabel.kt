...
import kotlinx.android.synthetic.main.activity_casa_annabel.*
import kotlinx.android.synthetic.main.layout_toolbar_common.*

class ActivityCasaAnnabel:BaseFragment() {
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.activity_casa_annabel,container,false)
    }
