...
class ActivityElTorrenon:BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.activity_el_torrenon,container,false)
    }
    ...
    fun setFindUsValue(){
        ...
        tv_facebook_find_us.setOnClickListener {
            goToWebViewScreen("","https://www.facebook.com/BAR-EL-TORREON-153828648021783/")
        }
        tv_phone_find_us.setOnClickListener {
            if (ContextCompat.checkSelfPermission(
                ...
                activity!!.makeCall("+34 952 57 58 04")
