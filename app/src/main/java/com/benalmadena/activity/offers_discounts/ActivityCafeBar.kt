...
class ActivityCafeBar:BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.activity_cafe_bar,container,false)
    }
    ...
    fun setFindUsValue(){
        ...
        tv_facebook_find_us.setOnClickListener {
            goToWebViewScreen("","https://www.facebook.com/plazaespanatorreon/")
        }
