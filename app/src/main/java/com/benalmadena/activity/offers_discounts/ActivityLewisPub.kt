...
class ActivityLewisPub:BaseFragment() {
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.activity_lewis_pub,container,false)
    }
    ...
    fun setFindUsValue(){
        ...
        tv_facebook_find_us.setOnClickListener {
            goToWebViewScreen("","https://www.facebook.com/lewisirishpub/")
        }
        ...
        tv_phone_find_us.setOnClickListener {
            if (ContextCompat.checkSelfPermission(
                ...
                activity!!.makeCall("+34 602 412 403")
